...
delayedTemperatureLowLimit='viivästetty alaraja'	-- Name of the lower temperature limit of delayed radiators in 'normal' state
delayedTemperatureHighLimit='viivästetty yläraja'	-- Name of the upper temperature limit of delayed radiators in 'normal' state
